...
//https://app.box.com/s/pdj2nlui838r989rpcn4
//Dropbox Token Issuer (Revised).application
//http://www.livetolearn.in/site/blog/dropbox-token-issuer-tool-revised-sharpbox

	
//App key: e56vivabidjt30l
//App secret:nvp80ymovcpwwvz

namespace DropBoxSharpBoxApi
{
    public class DropBoxSharpBox
    {
        string strAccessToken = @"c:\SharpDropBox.Token";
