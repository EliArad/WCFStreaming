...
namespace WatsonFieldInstaller
{
    ...
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            label1.Text = "Goji DropBox services setup " + Properties.Settings.Default.WatsonInstallerVersion;
        ...
        void DeleteAllFiles()
        {
            try
            {
                string[] files = System.IO.Directory.GetFiles(@"C:\Program Files\Goji Solutions\GojiLTDTrunk\WCF Streaming\GojiDropBoxService\bin\Release");
        ...
        string ProcessThread_1()
        {
            ...
            try
            {
                ...
                if (ServiceInstaller.ServiceIsInstalled("GojiDropBoxService") == true)
                {
                    ServiceInstaller.StopService("GojiDropBoxService");
                    ...
                    if (ServiceInstaller.getStatus("GojiDropBoxService") == "Running")
                    {
                        msg = "Service GojiDropBoxService not stopped";
                        MessageBox.Show(msg);
                        return "ok";
                    }
                }
               ...
               // FebrisInstaller.CreateShortcuts(true);
                ...
                ///////////////// INSTALL GojiDropBoxService  Service /////////////////////
                if (ServiceInstaller.ServiceIsInstalled("GojiDropBoxService") == false)
                {
                    ServiceInstaller.InstallAndStart("GojiDropBoxService", "Goji DropBox Service", @"C:\Program Files\Goji Solutions\GojiLTDTrunk\WCF Streaming\GojiDropBoxService\bin\Release\GojiDropBoxService.exe");
                    ...
                    if (ServiceInstaller.getStatus("GojiDropBoxService") != "Running")
                    {
                        msg = "Service GojiDropBoxService did not started";
                    }
                }
                else
                {
                    ServiceInstaller.StartService("GojiDropBoxService");
                ...
                AuthorizeApplication("GojiDropBoxService", @"C:\Program Files\Goji Solutions\GojiLTDTrunk\WCF Streaming\GojiDropBoxService\bin\Release\GojiDropBoxService.exe",
