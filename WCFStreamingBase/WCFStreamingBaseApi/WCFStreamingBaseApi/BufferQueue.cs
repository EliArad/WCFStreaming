...
namespace BufferQueueApi
{
    public class BufferQueue
    {
        ...
        public void append(byte[] data, int size) { if (data != null) append(data, 0, size); }
        ...
        public int read(byte[] data, int size) { if (data != null) return read(data, 0, size); else return 0; }
